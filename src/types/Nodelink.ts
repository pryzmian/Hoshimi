...
/**
 * Determines if nodelink is supported based on CustomizableOptions.
 */
...
/**
 * The nodelink voice connection structure.
 */
interface NodelinkVoice extends LavalinkPlayerVoice {
    /**
     * The channel id the player is connected to.
     * @type {string}
     */
    channelId: string;
}
